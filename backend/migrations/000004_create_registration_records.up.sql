...
CREATE TABLE registration_s1_detail (
    ...
    registration_type ENUM('BARU', 'ALIH_JENJANG', 'TRANSFER') DEFAULT NULL,
    ...
    previous_highschool VARCHAR(100) DEFAULT NULL,
    highschool_gpa DECIMAL(5,2) DEFAULT NULL,
    highschool_graduate_year YEAR DEFAULT NULL,

    program_studi_id BINARY(16) DEFAULT NULL COMMENT 'Major Choice',
    class_session ENUM('PAGI', 'MALAM') DEFAULT NULL,

    is_fresh_graduate_declared BOOLEAN NOT NULL DEFAULT FALSE,
    is_final_declaration_agreed BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE registration_s2_detail (
    ...
    phone_number VARCHAR(15) DEFAULT NULL,
    religion ENUM('NOT_SPECIFIED', 'ISLAM', 'KATOLIK', 'KRISTEN', 'HINDU', 'BUDDHA', 'KONGHUCU') DEFAULT NULL,
    funding_source ENUM('SENDIRI', 'INSTANSI', 'LAINNYA') DEFAULT NULL,
    ...
    previous_university VARCHAR(150) DEFAULT NULL,
