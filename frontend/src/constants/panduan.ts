...
export const panduanList: PanduanItem[] = [
  {
    ...
    pdfUrl: "/docs/panduandocs/Pembuatan_Akun.pdf",
    gradientKey: "blue",
  },
  {
    id: "pendaftaran",
    ...
    pdfUrl: "/docs/panduandocs/Pendaftaran.pdf",
    gradientKey: "purple",
  },
  {
    id: "ubah-biodata",
    ...
    descriptionId: "Perbaiki atau perbarui data pribadi setelah pendaftaran.",
    pdfUrl: "/docs/panduandocs/Ubah_Biodata.pdf",
    gradientKey: "green",
  },
  {
    ...
    pdfUrl: "/docs/panduandocs/Upload_Bukti_Transfer.pdf",
    gradientKey: "orange",
  },
  {
    id: "daftar-ulang",
    ...
    descriptionId: "Selesaikan proses daftar ulang setelah dinyatakan lulus.",
    pdfUrl: "/docs/panduandocs/Daftar_Ulang.pdf",
    gradientKey: "teal",
  },
  {
    id: "syarat-ospek",
    ...
    descriptionId: "Lengkapi persyaratan untuk mengikuti orientasi mahasiswa baru.",
    pdfUrl: "/docs/panduandocs/Syarat_Ospek.pdf",
    gradientKey: "pink",
  },
  {
    id: "pindah-prodi",
    ...
    pdfUrl: "/docs/panduandocs/Permintaan_Pindah_Prodi.pdf",
    gradientKey: "indigo",
  },
];
