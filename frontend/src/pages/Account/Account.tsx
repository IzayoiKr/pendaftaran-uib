...
function RegistrationCardItem({
    ...
    return (
        <section className={`${styles.card} ${styles.cardAccent}`}>
            ...
            {reg.status === "VERIFIED" &&
                (reg.examinee_id || reg.usm_password) && (
                ...
                {reg.status === "VERIFIED" && (
                    <div className={styles.actionGrid}>
                        ...
                        <button
                            ...
                            onClick={() =>
                                router.push("/account/transfer-proof")
                            }
                            disabled={isActionDisabled}
                        >
                        ...
                        <button
                            className={`${styles.btn} ${styles.btnSecondaryOutline}`}
                            onClick={() => router.push("/account/prodi")}
                            disabled={isActionDisabled}
                        >
                        ...
                        <button
                            className={`${styles.btn} ${styles.btnSecondaryOutline}`}
                            onClick={() =>
                                router.push("/account/prasyarat-ospek")
                            }
                            disabled={isActionDisabled}
                        >
...
function EmptyRegistration({ onRegister }: { onRegister: () => void }) {
    ...
    return (
        <section className={`${styles.card} ${styles.cardEmpty}`}>
            ...
            <h3 className={styles.emptyTitle}>{t("noRegistration")}</h3>
            <p className={styles.emptyText}>{t("noRegistrationDesc")}</p>
            <button
                className={`${styles.btn} ${styles.btnPrimary}`}
                onClick={onRegister}
            >
    ...
    return (
        <section className={styles.card}>
            ...
            <div className={styles.quickGrid}>
                ...
                >
                    <LockIcon />
                    <span>{t("quickChangePassword")}</span>
                </button>
                <button
                    className={styles.quickBtn}
                ...
                >
                    <ProfileIcon />
                    <span>{t("quickUpdateProfile")}</span>
                </button>
                <button
