    ...
    <>
      ...
      <section id="tempat-tinggal-indonesia">
        ...
        <section id="informasi-asrama-uib">
          ...
          <p>
            Asrama Universitas
            Internasional Batam mulai
            beroperasi sejak tahun
            2019 dengan 1 (satu)
            gedung utama dan kapasitas
            hunian sebanyak 96
            mahasiswa perempuan dan
            104 mahasiswa laki-laki.
          </p>

          <p>
            Asrama dirancang untuk
          ...
          <p>
            ...
            berminat untuk menempati
            dormitori UIB, silakan
            menghubungi WhatsApp Humas
            UIB di{" "}
            <strong>
              0812-7526-2369
            </strong>
      ...
      <section id="tempat-tinggal-english">
        ...
        <p>
          ...
          Internasional Batam
          Dormitory has been
          operating since 2019 with
          one main building and a
          residential capacity of 96
          female students and 104
          male students.
        </p>

        <p>
          The dormitory is designed
          to provide a safe,
        ...
        <p>
          ...
          at the UIB dormitory may
          contact the UIB Public
          Relations WhatsApp number
          at{" "}
          <strong>
            0812-7526-2369
          </strong>
