    ...
    <>
        ...
        <section id="beasiswa-insan-mandiri">
          ...
          <ul>
            ...
            <li>
              ...
              tidak mampu dibuktikan
              dengan Surat Keterangan
              Tidak Mampu (SKTM)
              atau Kartu Indonesia
              Pintar (KIP);
            </li>
          </ul>
      ...
      <section id="beasiswa-english">
        ...
        <section id="cemerlang-scholarship">
          ...
          <ul>
            <li>
              High school report has
              an average score of 80.0;
            </li>
        ...
        <section id="insan-mandiri-scholarship">
          ...
          <ul>
            ...
            <li>
              Comes from economically
              disadvantaged family
              proven by economically
        ...
        <section id="prestasi-1-scholarship">
          ...
          <ul>
            ...
            <li>
              ...
              Fees (Main Tuition and
              Courses Fee)
              for up to 6 semesters.
            </li>
          </ul>
        </section>
