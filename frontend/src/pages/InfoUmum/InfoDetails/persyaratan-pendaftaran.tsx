      ...
      <section id="persyaratan-pendaftaran">
        ...
        <section id="persyaratan-regular">
          ...
          <ol>
            ...
            <li>
              ...
              (KTP/Kartu
              Pelajar/Paspor),
              di-scan dalam bentuk PDF
              maksimal 2 MB.
            </li>

            <li>
              Foto soft copy ukuran
              2×3, background biru dan
        ...
        <section id="persyaratan-beasiswa">
          ...
          <ol>
            ...
            <li>
              Pas foto softcopy
              background biru ukuran
              2×3 dalam format PDF
              maksimal 2 MB;
            </li>

            <li>
              Mengisi nilai
              rata-rata rapor dari
              semester 1 sampai
              semester 4;
            </li>
        ...
        <section id="persyaratan-luar-negeri">
          ...
          <p>
            Sedangkan Ijazah SMA
            wajib disetarakan di
            Kemendikbud Jakarta.
          </p>

          <p>
            Pendaftar juga dapat
            melampirkan Ijazah dan
            SKHU Paket C yang
            sudah terbit.
          </p>
      ...
      <section id="requirements-registration">
        ...
        <section id="requirements-regular">
          ...
          <ol>
            ...
            <li>
              ...
              of registering on the
              available
              registration batch in
              the registration
              account.
            </li>
          </ol>
        ...
        <section id="requirements-transfer">
          ...
          <ol>
            ...
            <li>
              The equalization form
              that has been signed
              by the Vice Rector I
              will be submitted to
              the registrant
              through email and
              then continue the
              registration process
              and the UIB Entrance
              Examination.
            </li>
          </ol>
        </section>
        ...
        <section id="requirements-overseas">
          ...
          <p>
            ...
            attach certificates and
            SKHU Paket C which have
            already been issued.
          </p>
