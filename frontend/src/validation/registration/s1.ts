...
export const s1DraftSchema = (t: TV) =>
    z
        .object({
            ...
            ktp: optPdf(t, "ktp"),
            kk: optPdf(t, "kk"),
            transkripNilai: optPdf(t, "transkripNilai"),
            ijazahDok: optPdf(t, "ijazahDok"),
            sktmKip: optPdf(t, "sktmKip"),
            fotoRumah: optPdf(t, "fotoRumah"),
            tagihanListrik: optPdf(t, "tagihanListrik"),
            tagihanAir: optPdf(t, "tagihanAir"),
            sertifikatPrestasi: optPdf(t, "sertifikatPrestasi"),
            rapot1: optPdf(t, "rapot1"),
            rapot2: optPdf(t, "rapot2"),
            rapot3: optPdf(t, "rapot3"),
            rapot4: optPdf(t, "rapot4"),
